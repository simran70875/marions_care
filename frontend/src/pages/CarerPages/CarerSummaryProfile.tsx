...
const aboutMeContent: AboutMeQA[] = [
  ...
  },
  {
    ...
    answer:
      "A: Charlie would like the carers to promote him to get involved in his own care to allow him to build up his strength and ability to complete day to day tasks. Charlie would like carers to be kind a...",
  },
  {
    question: "Q: What is most important to me",
    answer:
      "A: Charlie said that regaining his independence and get his life as back to normal as possible is something that is very important to him as he has spent a lot time in hospital (14 months)",
  },
  {
    question: "Q: Please Don't",
    answer:
      "A: Please do not try to take my independence away from me, this is something that is very important to me.",
  },
  {
    question: "Q: People who are important to me",
    answer:
      "A: Charlie is very close to his brother and sister (and their children), unfortunately his parents have passed away but he is also close to his auntie (who is now his NOK)",
  },
  {
    question: "Q: How and when to support me",
    answer:
      "A: I am able to walk short distances with my walking stick however due to having my right arm amputated (I require some additional support with carrying things as I am unable). Please help with all me...",
  },
  {
    question: "Q: How I communicate and how to communicate with me",
    answer:
      "A: Charlie is able to communicate effectively verbally in English and would like the care team to communicate the same.",
  },
  {
    question: "Q: Also worth knowing about me",
    answer:
      "A: Charlie is a young gentleman that unfortunately was a victim of a stabbing when he was 26. This lead to for a long 14 months in hospital where he had (right arm amputated), multiple other operatio...",
  },
  {
    question: "Q: My wellness",
    answer:
      "A: Charlie said both his mental and physical health improve when he is eating well and training well in the gym. This is something he would like to make sure he incorporates into his daily life.",
  },
];
...
const contactData: ContactDetail[] = [
  {
    type: "Next Of Kin",
    contact: "Charlie O’Connor",
    tel: "07744180807",
    address: "148, The Broadway, Wythenshawe, M22 4HY",
  },
...
const InfoCard: React.FC<{
  ...
  editable?: boolean;
}> = ({ title, children, isActive = false, icon, editable = false }) => (
...
const SectionCard: React.FC<{
  ...
  badge?: string;
  badgeColor?: string;
}> = ({ title, children, badge, badgeColor = "bg-gray-100" }) => (
...
export default function CarerSummaryDetails() {
      ...
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="col-span-1">
          <InfoCard title="Personal Details" isActive={true}>
            ...
            <DetailItem
              label="DOB"
              value={`${clientData.dob} (Age: ${clientData.age})`}
            />
            <DetailItem
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        ...
        >
          <p className="line-clamp-4">
            Charlie is an avid football fan and enjoys watching matches with his
            brother. He has a great sense of humor and loves reading sci-fi
            novels in his spare time. He is a generally positive person who is
            focused on regaining his independence and living life to the fullest
        ...
        <SectionCard title="Contacts">
          <div className="space-y-2">
            {contactData.map((contact, index) => (
              <div
                key={index}
                className="pb-1 border-b border-gray-100 last:border-b-0"
              >
        ...
        >
          <p className="text-gray-800 font-medium mb-1">
            Team Meeting Notes (02/10/2025):
          </p>
          <p className="line-clamp-5">
            Reviewed care plan adherence. Carers are advised to continue
            encouraging independence, particularly during morning routines.
            Ensure two-carer assistance is consistently provided for transfers.
            New medication protocol starting next week, see attached notes for
            details. Carers must sign off on the new protocol immediately.
          </p>
          <button className="mt-2 text-blue-600 text-xs font-medium hover:underline">
            View all
          </button>
        ...
        >
          ...
          {preferredCarers.map((carer, index) => (
            <div
              key={index}
              className="grid grid-cols-[1fr_auto_auto] gap-x-2 items-center py-1"
            >
